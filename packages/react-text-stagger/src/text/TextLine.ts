import { ElementOptions, StaggerElement } from "../element/index.js";
import { Text } from "./Text.js";
import { Ranges } from "../ranges/index.js";
import { AnimatedBox } from "../element/AnimatedBox.js";

export class TextLine extends Ranges<AnimatedBox> {
  private constructor(
    public text: Text,
    public index: number,
    ranges: Range[],
