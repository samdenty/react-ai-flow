import { AnimatedBox, AnimatedBoxOptions } from "../element/AnimatedBox.js";
...
export class Text extends Ranges<AnimatedBox> {
  lines: TextLine[];
  ...
  split(...textSplitters: TextSplitter[]): StaggerElement[] {
    const { splitter, ...options } =
      getTextSplitterWithDefaults<AnimatedBoxOptions>(
        this.options,
        ...textSplitters
      );
